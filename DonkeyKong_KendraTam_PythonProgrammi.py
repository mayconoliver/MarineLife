...
title = pygame.transform.scale(title, (650, 750))
start = pygame.image.load("start.png")
winScreen = pygame.image.load("win-screen.png")
gameOverScreen = pygame.image.load("game-over-screen.png")
gameOverScreen = pygame.transform.scale(gameOverScreen, (740, 813))
...
withLadder = pygame.transform.scale(withLadder, (740, 813))
platform0 = pygame.image.load("platform0.png")
platform0 = pygame.transform.scale(platform0, (740, 813))
platform1 = pygame.image.load("platform1.png")
platform1 = pygame.transform.scale(platform1, (740, 813))
platform2 = pygame.image.load("platform2.png")
platform2 = pygame.transform.scale(platform2, (740, 813))
platform3 = pygame.image.load("platform3.png")
platform3 = pygame.transform.scale(platform3, (740, 813))
platform4 = pygame.image.load("platform4.png")
platform4 = pygame.transform.scale(platform4, (740, 813))
platform5 = pygame.image.load("platform5.png")
platform5 = pygame.transform.scale(platform5, (740, 813))
platform6 = pygame.image.load("platform6.png")
platform6 = pygame.transform.scale(platform6, (740, 813))
platforms = [platform0, platform1, platform2, platform3, platform4, platform5, platform6]
level = pygame.image.load("level.png")
level = pygame.transform.scale(level, (740, 813))
