...
fullLadderUp = [False, True, True, False, True, True, False, True, False, True, True, True, False, True, False, True,
                False, True, True, True]
fullLadderDown = [True, True, False, True, False, True, True, True, True, False, False, True, True, False, True, False,
...
title = pygame.transform.scale(title, (800, 700))
...
marioLeft = pygame.image.load("peixe-left.png")
marioRight = pygame.image.load("peixe-right.png")
runLeft = pygame.image.load("peixe-left.png")
runRight = pygame.image.load("peixe-right.png")
marioJumpLeft = pygame.image.load("peixe-left.png")
marioJumpRight = pygame.image.load("peixe-right.png")
marioClimb1 = pygame.image.load("peixeClimb1.png")
marioClimb2 = pygame.image.load("peixeClimb2.png")
...
def collide() -> bool:
    ...
    for i in range(0, len(barrelX)):
        ...
        if marioX + 20 >= barrelX[i] and marioX <= barrelX[i] + 26 and marioY + 30 >= barrelY[i] and marioY <= barrelY[
            i] + 20:
            hit = True
...
while replay:
    ...
    while inPlay:
            ...
            if hit == False:
                ...
                if jumpLeft or jumpRight or jumpStill:
                    ...
                    for i in range(0, len(barrelX)):
                        ...
                        if marioX >= barrelX[i] and marioX <= barrelX[i] + 28 and marioY <= barrelY[
                            i] - 23 and marioY >= barrelY[i] - 65:
                            jumpPoint = 1
                ...
                if scoreWin == False:
                    ...
                    for i in range(0, len(barrelPic)):
                        ...
                        if (barrelY[i] <= 255 and barrelY[i] >= 243) or (barrelY[i] <= 452 and barrelY[i] >= 415) or (
                                barrelY[i] <= 648 and barrelY[i] >= 611):
                            barrelDirection[i] = "right"

                        elif (barrelY[i] <= 353 and barrelY[i] >= 317) or (barrelY[i] <= 550 and barrelY[i] >= 513) or (
                                barrelY[i] <= 731 and barrelY[i] >= 709):
        ...
        if (
                gameStart and jumpLeft == False and jumpRight == False and jumpStill == False and winLevel == False and hit == False) or gameDone or winGame:
